...
from app.services.math_service import compute_pow, compute_factorial, compute_fibonacci
...
def synch_test():
    ...
    print(f"Time taken for synchronous operations: {end - start:.4f} seconds)\n")
...
async def async_test():
    ...
    print(f"Time taken for asynchronous operations: {end - start:.4f} seconds)\n")
